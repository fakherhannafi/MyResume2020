...
Software Engineer at BPCE Bank || 4x AWS Certified}\textcolor{myBlack}{\textsuperscript{\textregistered}}
\textcolor{Orange}{
\begin{tikzpicture}
...
\personalinfo{
\item {\textcolor{orange}{\faCircle} 25 Years Old} \hspace{22.7mm} \location{Aix En Provence, France} 
...
\cvevent{Upgrade Big Data Platform to HDP 3.1}{Infrastructure Engineer}{April 2019 -- 
Ongoing}{}
\begin{itemize}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  3/8em/accent!40/Networking with AWS Architects,
  8/8em/accent!60/Table Tennis,
...
\divider\\
\cvachievement{\faTrophy}{National Diploma of Music}{Music Teacher, Violin, Piano}
...
\cvtag{Web}\cvtag{Cloud}\cvtag{Data}\cvtag{Devops}\\

\cvtag{Agile}\cvtag{Scrum}\cvtag{ITIL}\cvtag{ITSM}\\

\divider\smallskip\\
\cvtag{Angular}\cvtag{Node.js}\cvtag{Python}\cvtag{Powershell}\cvtag{AWS}\cvtag{Jenkins}\cvtag{Ansible}\cvtag{Linux}\cvtag{Docker}\cvtag{Elastic}\cvtag{Oracle}\cvtag{Power BI}\cvtag{Grafana}\\
...
\cvevent{IT Engineering}{Higher School Of Communication \break
